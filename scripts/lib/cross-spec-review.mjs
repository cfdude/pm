...
import { archivedChangeDir, strippedChangeId } from "./epic-progress.mjs";
 ...
 *
 *  The archived directory is the ONE resolver's — epic-progress.mjs archivedChangeDir(), the same
 *  match isArchived(), archivedTasksPath() and the spec-sync check use: latest date prefix wins, an
 *  undated directory ranks below every dated one. This used to take the FIRST stripped match in
