...
test("2.1 the unit rung performs no filesystem work at all, and lives in one process with the half", () => {
  ...
  assert.ok(files.length >= 58,
    ...
    "(515, the worklist's first thirty rows), 43 BY BATCH 5 (rows 31-40) AND 58 BY BATCH 6 (rows " +
    "41-50): a number left below the rung's real size is still doing its job; a walk over an empty " +
    "rung is not");
