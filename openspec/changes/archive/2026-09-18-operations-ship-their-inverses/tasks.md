...
- [x] 5.5 `CHANGELOG.md` `[Unreleased]` entry, and the `.claude-plugin/plugin.json` version bump.
  (Mintlify sync belongs to the release cut, not to this change.)

## 6. Gate 2 and close

- [x] 6.1 **Gate 2 — implementation review.** TWO fresh-context lenses over the committed
