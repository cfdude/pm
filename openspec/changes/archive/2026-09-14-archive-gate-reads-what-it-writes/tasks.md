...
- [x] 3.4d RED (Gate 2 re-review): an uncovered commit reference (a git tag) carrying U+2028 and U+0085
      is escaped on the regression refusal's detail line and forges no line
