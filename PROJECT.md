...
> Last rendered: 2026-07-30T04:49:26.887Z

## Now

**`test-suite-perf-and-scaffolding`** — Split the test suite for parallelism (~120s -> ~20s) and close the silent-pass holes in its scaffolding (epic, P1) — 2/8 stories
...
|----------|------|------|------|--------|----------|-------|
| P1 | `test-suite-perf-and-scaffolding` | superpowers | epic | active | 2/8 stories | - |
...
NOW: `test-suite-perf-and-scaffolding` (superpowers, epic, P1) — 2/8 stories
