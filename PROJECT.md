...
> Last rendered: 2026-07-30T04:01:43.761Z

## Now

**`gh-65-autodetour-false-positives`** — auto-detour writes false-positive entries: no success check + no repo-scope check (epic, P1) — 2/4 stories
...
|----------|------|------|------|--------|----------|-------|
| P1 | `test-suite-perf-and-scaffolding` | superpowers | epic | queued | 0/6 stories | - |
...
| P1 | `gh-65-autodetour-false-positives` | claude-code | epic | active | 2/4 stories | - |
...
NOW: `gh-65-autodetour-false-positives` (claude-code, epic, P1) — 2/4 stories

NEXT UP (by priority, then lane):
  • `test-suite-perf-and-scaffolding` (P1, superpowers, queued) — 0/6 stories
