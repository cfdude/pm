...
> Last rendered: 2026-07-30T05:01:16.712Z

## Now

**`test-suite-perf-and-scaffolding`** — Split the test suite for parallelism (~120s -> ~20s) and close the silent-pass holes in its scaffolding (epic, P1) — 5/10 stories
...
|----------|------|------|------|--------|----------|-------|
| P1 | `test-suite-perf-and-scaffolding` | superpowers | epic | active | 5/10 stories | - |
...
NOW: `test-suite-perf-and-scaffolding` (superpowers, epic, P1) — 5/10 stories
