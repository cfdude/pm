...
> Last rendered: 2026-08-13T22:21:32.706Z
...
| P2 | `edd-measures-installed-plugin-not-worktree` | claude-code | epic | active | — | blocks→hermes-platform-support |
...
| P3 | `multi-platform-agent-support` | claude-code | epic | queued ⚠ stale, 19d active | 3/5 children archived | - |
...
NEXT UP (by priority, then lane):
  ...
  lanes: openspec 3 · superpowers 5 · claude-code 61 · decision 7
...
TRACKER SYNC (github-issues):
  ⚠ not yet in github-issues — create issues + record keys (update-epic): `state-lost-update-concurrent-sessions`, `autodetour-parser-misses-am-and-f`, `edd-adapter-discards-agent-stdout`, `edd-corpus-expansion-nondeterministic-surfaces`, `edd-measures-installed-plugin-not-worktree`, `platform-switch-orphans-old-rules-block`, `multi-platform-agent-support`
