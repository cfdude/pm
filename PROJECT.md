...
> Last rendered: 2026-07-30T02:39:57.527Z
...
| P1 | `gh-65-autodetour-false-positives` | claude-code | epic | queued | 0/3 stories | - |
...
| P2 | `gh-64-sync-duplicate-shipped-plan` | claude-code | epic | queued | — | - |
...
NEXT UP (by priority, then lane):
  ...
  • `gh-65-autodetour-false-positives` (P1, claude-code, queued) — 0/3 stories
  ...
  lanes: openspec 2 · superpowers 1 · claude-code 53 · decision 7
