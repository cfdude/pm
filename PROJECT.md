...
> Last rendered: 2026-07-30T22:52:14.571Z

## Now

**`edd-user-memory-confound-control-run`** — EDD baseline confound: user-scope CLAUDE.md carries the lane heuristic; needs a memory-suppressed control run (epic, P1) — 0/5 stories
...
| P1 | `edd-user-memory-confound-control-run` | claude-code | epic | active | 0/5 stories | blocks→hermes-platform-support |
...
NOW: `edd-user-memory-confound-control-run` (claude-code, epic, P1) — 0/5 stories
