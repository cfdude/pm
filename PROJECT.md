...
> Last rendered: 2026-07-30T23:05:05.491Z

## Now

**`edd-user-memory-confound-control-run`** — EDD baseline confound: user-scope CLAUDE.md carries the lane heuristic; needs a memory-suppressed control run (epic, P1) — 4/7 stories
...
| P1 | `edd-user-memory-confound-control-run` | claude-code | epic | active | 4/7 stories | blocks→hermes-platform-support |
...
NOW: `edd-user-memory-confound-control-run` (claude-code, epic, P1) — 4/7 stories
